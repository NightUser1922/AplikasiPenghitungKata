...
private int countOccurrences(String text, String keyword) {
    ...
    String keyword = txtCariKata.getText().trim();
    String text = txtAreaInput.getText();
    ...
    // Gunakan case-insensitive
    String lowerText = text.toLowerCase();
    String lowerKeyword = keyword.toLowerCase();

    // Cari dari posisi setelah hasil sebelumnya
    int pos = lowerText.indexOf(lowerKeyword, lastSearchIndex);

    if (pos >= 0) {
        // Pilih teks di posisi tersebut
        txtAreaInput.requestFocus();
        txtAreaInput.select(pos, pos + keyword.length());
        
        // Update posisi pencarian berikutnya
        lastSearchIndex = pos + keyword.length();

        // Hitung total kemunculan
        int found = countOccurrences(text, keyword);
        lblHasilCari.setText(String.valueOf(found));

    } else {
        // Tidak ada hasil berikutnya → mulai ulang dari awal
        JOptionPane.showMessageDialog(this, 
            "Tidak ada lagi hasil berikutnya.\nMencari ulang dari awal...",
            "Pencarian Selesai", JOptionPane.INFORMATION_MESSAGE);
